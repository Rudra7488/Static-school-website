  ...
  const academicLevels = [
    {
      ...
      img: "https://images.pexels.com/photos/8422184/pexels-photo-8422184.jpeg?auto=compress&cs=tinysrgb&w=800",
      ...
      <div className="max-w-6xl mx-auto px-5 mb-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
             ...
             <h2 className="text-5xl md:text-6xl font-black font-serif text-primary leading-tight">
               Our Learning <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary italic">Pathways</span>
             </h2>
          </div>
        ...
        {academicLevels.map((level, idx) => (
          <div key={idx} className="group relative bg-white rounded-[2.5rem] border border-gray-100 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4">
            ...
            <div className={`p-10 bg-gradient-to-br ${level.gradient} flex flex-col items-center text-center space-y-4`}>
              <h3 className="text-2xl font-black font-serif text-primary">{level.title}</h3>
